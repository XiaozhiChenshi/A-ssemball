...
func _build_preview() -> void:
	...
	for font_name in FONT_CANDIDATES:
		grid.add_child(_create_font_card(font_name))


func _create_font_card(font_name: String) -> Control:
	...
	sample.add_theme_font_override("font", _make_system_font(font_name))
...
func _make_system_font(font_name: String) -> SystemFont:
